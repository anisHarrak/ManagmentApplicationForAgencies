...
void MENU_PRINCIPAL()
{
	...
	int choix=0;
      ...
      do{
		...
		cout<<"\t      \t   4-GESTION DU MENU DES AGENCES "<<endl;
		cout<<"\t      \t   5-Quitter "<<endl;
...
void MENU_GESTION_AGENCE()
{
	...
	cout<<"\n\n\t\t************************************************ "<<endl;
	cout<<" \t\t *********** gestion des agences: ********** "<<endl;
	cout<<"	 \t      ************************************"<<endl;
	cout<<"\t\n\n\t\t   1-Ajouter une agence "<<endl;
	cout<<"\t\t   2-Afficher la liste des agences "<<endl;
	cout<<"\t\t   3-Supprimer une agence "<<endl;
	cout<<"\t\t   4-rechercher une agence "<<endl;
	cout<<"\t\t   5-Quitter "<<endl;
	cout<<"\nS'il vous plait entrer votre choix:\n ";
	char s[10];
	...
	switch (choix) {
		...
		case 3:
			S.consulteragence();
			cout<<"entrer le numéro d'agence à supprimer : ";
			int b;
			char s[10];
			b=A.saisir_entier(s);
			S.supprimeragence(b);
			S.envoyer_messageSuppAgence(b);
			MENU_GESTION_AGENCE();
			break;
		case 4:
			cout<<"entrer le numéro d'agence à rechercher : ";
			int d;
			char ss[10];
			d=A.saisir_entier(ss);
			S.rechercheragence(d);
			MENU_GESTION_AGENCE();
			break;
